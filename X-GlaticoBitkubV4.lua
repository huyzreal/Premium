...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://115411336467329",
...
local v15 = v14:CreateWindow({
    Title = "Normal Hub Blox-Fruit [ Premium ]",
    SubTitle = "By huyz",
    TabWidth = 160,
    Theme = "Dark Purple",
    Acrylic = true,
...
local v92 = v16.Setting:AddToggle("ToggleWhite", {
    ...
    Description = "Dành Cho Đứa Nào Muốn Tiết Kiệm Pin",
    Default = false
});
...
v14:Notify({
    Title = "Loading...",
    Content = "Welcome Players I'm Back",
    Duration = 10
});
